  ...
  return (
    <>
      <div className="w-full mt-4 md:mt-20 flex justify-center items-center">
        ...
        <div className="plus mx-10 flex items-center">
          <svg
            className="text-white  w-16 md:w-24"
      ...
      <div className="fixed left-0 bottom-0 w-full text-right pr-10 pb-10">
        <button
          className="bg-blue-500 hover:bg-blue-700 text-white p-4 rounded-full font-bold text-3xl"
          onClick={incrementCount}
        >
          <svg
            className="text-white w-8 md:w-10"
            viewBox="0 0 1024 1024"
            fill="currentColor"
          >
            <defs>
